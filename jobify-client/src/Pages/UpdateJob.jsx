        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="create-job-flex">
                <div className="lg:w-1/2 w-full">
                    ...
                    <input type="text" placeholder="2000" defaultValue={minPrice}
                        {...register("minPrice")} className="create-job-input" />
                </div>

                <div className="lg:w-1/2 w-full">
                    <label className="block mb-2 text-lg" >Maximum Salary </label>
                    <input type="text" placeholder="12000" defaultValue={maxPrice}
            ...
            <div className="create-job-flex">
                <div className="lg:w-1/2 w-full">
                    ...
                    <input type="date" placeholder="Ex: 2024-01-28" defaultValue={postingDate}
            ...
            <div className="create-job-flex">
                <div className="lg:w-1/2 w-full">
                    ...
                    <input type="url" placeholder="Paste Company Logo URL:https://www.google.com/img1"
                        {...register("companyLogo")} defaultValue={companyLogo} className="create-job-input" />
                </div>
            ...
            <div className="w-full">
                ...
                <textarea defaultValue={description} className="w-full pl-3 py-1.5 focus:outline-none placeholder:text-gray-500" rows={6} placeholder="Job Description" {...register("description")}></textarea>
            </div>

            {/* 8th row */}
            <div className="w-full">
                <label className="block mb-2 text-lg" > Job Posted By </label>
                <input type="email" placeholder="Email is..." defaultValue={postedBy}
